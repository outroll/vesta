...
#
# Usage: src/deb/nginx/build.sh [VERSION]
...
dpkg-deb --build --root-owner-group "$PKGROOT" "$REPO_ROOT/vesta-nginx_amd64.deb"

echo "Built $REPO_ROOT/vesta-nginx_amd64.deb (nginx $NGINX_VERSION, package version $VERSION)"
