...
%build
./configure --prefix=/usr/local/vesta/php --enable-fpm --with-fpm-user=admin --with-fpm-group=admin  --with-mysqli --with-bz2 --with-zlib --enable-zip --enable-mbstring --with-mcrypt
