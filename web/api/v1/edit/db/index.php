...
exec (devit_CMD."v-list-database ".$user." ".$v_database." json", $output, $return_var);
...
if (!empty($_POST['save'])) {
    ...
    if (($v_dbuser != $_POST['v_dbuser']) && (empty($_SESSION['error_msg']))) {
        ...
        exec (devit_CMD."v-change-database-user ".$v_username." ".$v_database." ".$v_dbuser, $output, $return_var);
        check_return_code($return_var,$output);
        unset($output);
    ...
    if ((!empty($_POST['v_password'])) && (empty($_SESSION['error_msg']))) {
        ...
        fclose($fp);
        exec (devit_CMD."v-change-database-password ".$v_username." ".$v_database." ".$v_password, $output, $return_var);
        check_return_code($return_var,$output);
        unset($output);
        unlink($v_password);
