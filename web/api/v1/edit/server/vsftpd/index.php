...
if (!empty($_POST['save'])) {
    ...
    if (!empty($_POST['v_config'])) {
        ...
        fclose($fp);
        exec (devit_CMD."v-change-sys-service-config ".$new_conf." vsftpd ".$v_restart, $output, $return_var);
...
$v_config_path = shell_exec(devit_CMD.'v-list-sys-vsftpd-config plain');
