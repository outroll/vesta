...
if ((!empty($_GET['domain'])) && (empty($_GET['record_id'])))  {
    ...
    exec (devit_CMD."v-list-dns-domain ".$user." ".$v_domain." json", $output, $return_var);
...
if ((!empty($_GET['domain'])) && (!empty($_GET['record_id'])))  {
    ...
    exec (devit_CMD."v-list-dns-records ".$user." ".$v_domain." json", $output, $return_var);
    check_return_code($return_var,$output);
    $data = json_decode(implode('', $output), true);
    unset($output);
...
if ((!empty($_POST['save'])) && (!empty($_GET['domain'])) && (empty($_GET['record_id']))) {
    ...
    if (($v_template != $_POST['v_template']) && (empty($_SESSION['error_msg']))) {
        ...
        exec (devit_CMD."v-change-dns-domain-tpl ".$v_username." ".$v_domain." ".$v_template." no", $output, $return_var);
        check_return_code($return_var,$output);
        unset($output);
        $restart_dns = 'yes';
    }
    ...
    if (($v_soa != $_POST['v_soa']) && (empty($_SESSION['error_msg']))) {
        ...
        exec (devit_CMD."v-change-dns-domain-soa ".$v_username." ".$v_domain." ".$v_soa." no", $output, $return_var);
        check_return_code($return_var,$output);
        unset($output);
        $restart_dns = 'yes';
    }
    ...
    if (($v_exp != $_POST['v_exp']) && (empty($_SESSION['error_msg']))) {
        ...
        exec (devit_CMD."v-change-dns-domain-exp ".$v_username." ".$v_domain." ".$v_exp." no", $output, $return_var);
        check_return_code($return_var,$output);
        unset($output);
    }
    ...
    if (($v_ttl != $_POST['v_ttl']) && (empty($_SESSION['error_msg']))) {
        ...
        exec (devit_CMD."v-change-dns-domain-ttl ".$v_username." ".$v_domain." ".$v_ttl." no", $output, $return_var);
        check_return_code($return_var,$output);
        unset($output);
        $restart_dns = 'yes';
    }
...
if ((!empty($_POST['save'])) && (!empty($_GET['domain'])) && (!empty($_GET['record_id']))) {
    ...
    if (($v_val != $_POST['v_val']) || ($v_priority != $_POST['v_priority']) && (empty($_SESSION['error_msg']))) {
        ...
        exec (devit_CMD."v-change-dns-record ".$v_username." ".$v_domain." ".$v_record_id." ".$v_val." ".$v_priority, $output, $return_var);
        check_return_code($return_var,$output);
        $v_val = $_POST['v_val'];
        unset($output);
        $restart_dns = 'yes';
    ...
    if (($_GET['record_id'] != $_POST['v_record_id']) && (empty($_SESSION['error_msg']))) {
        ...
        exec (devit_CMD."v-change-dns-record-id ".$v_username." ".$v_domain." ".$v_old_record_id." ".$v_record_id, $output, $return_var);
        check_return_code($return_var,$output);
        unset($output);
        $restart_dns = 'yes';
    }
