...
if (!empty($_POST['ok'])) {
    ...
    if (empty($_SESSION['error_msg'])) {
        exec (VESTA_CMD."v-add-firewall-ipv6-rule ".$v_action." ".$v_ip." ".$v_port." ".$v_protocol." ".$v_comment, $output, $return_var);
...
// Display body
include($_SERVER['DOCUMENT_ROOT'].'/templates/admin/add_firewall_ipv6.html');
