...
class FileManager {
    ...
    public function checkFileType($dir) {
        ...
        exec(devit_CMD . "v-get-fs-file-type {$this->user} {$dir}", $output, $return_var);
    ...
    function deleteItem($dir, $item) {
        ...
        exec (devit_CMD . "v-delete-fs-directory {$this->user} {$dir}", $output, $return_var);
    ...
    function copyFile($item, $dir, $target_dir, $filename) {
        ...
        exec (devit_CMD . "v-copy-fs-file {$this->user} {$src} {$dst}", $output, $return_var);
    ...
    function copyDirectory($item, $dir, $target_dir, $filename) {
        ...
        exec (devit_CMD . "v-copy-fs-directory {$this->user} {$src} {$dst}", $output, $return_var);
    ...
    function createFile($dir, $filename) {
        ...
        exec (devit_CMD . "v-add-fs-file {$this->user} {$dir}", $output, $return_var);
	...
	$items = implode(' ', $items_arr);
        ...
        exec (devit_CMD . "v-add-fs-archive {$this->user} {$dst_item} {$items}", $output, $return_var);
    ...
    function backupItem($item) {
        ...
        exec (devit_CMD . "v-copy-fs-file {$this->user} {$src_item} {$dst_item}", $output, $return_var);
    ...
    function unpackItem($item, $dir, $target_dir, $filename) {
        ...
        exec (devit_CMD . "v-extract-fs-archive {$this->user} {$item} {$dst_item}", $output, $return_var);
    ...
    function renameFile($item, $target_name) {
        ...
        exec (devit_CMD . "v-move-fs-file {$this->user} {$item} {$dst_item}", $output, $return_var);
    ...
    function renameDirectory($item, $target_name) {
        ...
        exec (devit_CMD . "v-move-fs-directory {$this->user} {$item} {$dst_item}", $output, $return_var);
    ...
    function createDir($dir, $dirname) {
        ...
        exec (devit_CMD . "v-add-fs-directory {$this->user} {$dir}", $output, $return_var);
    ...
    function chmodItem($dir, $item, $permissions) {
        ...
        exec (devit_CMD . "v-change-fs-file-permission {$this->user} {$item} {$permissions}", $output, $return_var);
    ...
    function getDirectoryListing($dir = '') {
        ...
        exec (devit_CMD . "v-list-fs-directory {$this->user} {$dir}", $output, $return_var);
