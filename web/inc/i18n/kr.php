...
$LANG['kr'] = array(
    ...
    'Add Mail Domain'  => 'Mail 도메인 추가',
    'Add Mail Account'  => 'Mail 계정 추가',
    'Add Database'  => '데이터베이스 추가',
    'Add Cron Job'  => 'Cron Job 추가',
    'Create Backup'  => '백업 생성',
    'Configure'  => 'Configure',
    'Restore All'  => 'Restore All',
    'Add Package'  => 'Package 추가',
    'Add IP'  => 'IP Address 추가',
    'Add Rule' => '규칙 추가',
    'Ban IP Address' => 'IP Address 차단',
    'Search'  => '검색',
    'Add one more FTP Account' => '한개 이상의 FTP 계정 추가',
    ...
    'Adding Domain'  => '도메인 추가중',
    'Editing Domain'  => '도메인 편집중',
    'Adding DNS Domain'  => 'DNS Domain 추가중',
    'Editing DNS Domain'  => 'DNS Domain 편집중',
    ...
    'DELETE_USER_CONFIRMATION' => '%s 사용자를 삭제하는게 확실한가요?',
    'SUSPEND_USER_CONFIRMATION' => '%s 사용자를 정지시키는 것이 확실한가요?',
    'UNSUSPEND_USER_CONFIRMATION' => '%s 사용자를 정지해지 하는 것이 확실한가요?',
    'DELETE_DOMAIN_CONFIRMATION' => '%s 도메인을 삭제하는게 확실한가요??',
    ...
    'Welcome'  => '환영합니다',
    'LOGGED_IN_AS'  => '사용자 %s 로그인 됨',
    'Error'  => 'Error',
    'Invalid username or password'  => 'Invalid username or password.',
    'Invalid username or code'  => 'Invalid username or code.',
    'Passwords not match'  => '패스워드가 일치하지 않습니다.',
    'Please enter valid email address.'  => '유효한 이메일을 입력하세요.',
    'Field "%s" can not be blank.'  => 'Field "%s" can not be blank.',
    'Password is too short.'  => '패스워드가 너무 짧습니다 (최소 6글자)',
    ...
    'Configuring Server' => '서버 설정',
    'Hostname' => '호스트명',
    'Time Zone' => '타임존',
    'Default Language' => '기본 언어',
    'FileSystem Disk Quota ' => '파일 디스크 용량제한 ',
