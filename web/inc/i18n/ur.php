...
$LANG['ur'] = array(
    ...
    'Welcome to DevIT Control Panel'   => 'DevIT کی کنٹرول پینل میں خوش آمدید',
    'MAIL_FROM'   => '<noreply@%s> DevIT کی کنٹرول پینل ',
    ...
    'DevIT Control Panel Plugins'  => 'DevIT کی کنٹرول پینل پلگ انز',
    'preview'  => 'پیش نظارہ',
